...
@section('head')
    <h1 class="text-3xl font-bold tracking-tight text-primary-yellow">Log Peminjaman</h1>
@endsection
...
<form action="{{route('showLogFilter')}}" method="POST" class="flex items-center gap-4 bg-gray-100 p-4 rounded-lg">
    ...
    <button type="button" onclick="window.print()" class="bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg px-4 py-2">
        Print
    </button>
</form>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    ...
                    @elseif ($item->statusPeminjaman === 'Dipinjam')
                        <span class="px-2 py-1 text-yellow-700 bg-yellow-100 rounded-lg">Dipinjam</span>
                    @else
